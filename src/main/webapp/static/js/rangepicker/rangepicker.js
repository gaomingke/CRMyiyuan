                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-small" type="text" name="daterangepicker_start" value="" readonly="readonly" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label for="daterangepicker_end"></label>' +
                      '<input class="input-small" type="text" name="daterangepicker_end" value="" readonly="readonly" />' +
                    '</div>' +
